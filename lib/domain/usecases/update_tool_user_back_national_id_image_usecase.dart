...
class UpdateToolUserBackNationalIdImageUseCase
    implements UseCase<String?, UpdateToolUserBackNationalIdImageParams> {
  final ToolUsersRepo _toolUsersRepo;

  UpdateToolUserBackNationalIdImageUseCase({ToolUsersRepo? toolUsersRepo})
      : _toolUsersRepo = toolUsersRepo ?? locator<ToolUsersRepoImp>();

  @override
  Future<String?> call(UpdateToolUserBackNationalIdImageParams p) {
    return _toolUsersRepo.updateToolUserBackNationalIdImagePath(
        p.toolUserBackNationalIdImagePath, p.toolUserId);
  }
}
...
class UpdateToolUserBackNationalIdImageParams {
  ...
  UpdateToolUserBackNationalIdImageParams(
      {required this.toolUserBackNationalIdImagePath,
