          ...
          child: Column(
            children: [
              GestureDetector(
                ...
                onTap: () => viewModel.navigateToToolImageView(),
              ),
              verticalSpaceMedium,
              Expanded(
                    ...
                    children: [
                      ...
                      CustomListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: switch (viewModel.toolStatus) {
                            ...
                            _ => () {
                                viewModel
                                    .showDialog(DialogType.toolStatusEditor);
                      ...
                      CustomListTile(
                        ...
                        trailing: IconButton(
                          ...
                          iconSize: 26.0,
                          onPressed: () {
                            viewModel.showDialog(DialogType.toolRateEditor);
                          },
                        ),
                      ),
                      verticalSpaceSmall,
                      CustomListTile(
                        ...
                        trailing: IconButton(
                          ...
                          iconSize: 26.0,
                          onPressed: () {
                            viewModel.showDialog(DialogType.toolCategoryEditor);
                          },
                        ),
                      ),
                      verticalSpaceSmall,
                      ...
                      CustomListTile(
                        ...
                        subtitle: Text(
                          viewModel.toolPurchaseDate?.toIso8601String() ??
                              'placeHolder',
                          style: switch (
                              getThemeManager(context).selectedThemeMode) {
                            ThemeMode.light =>
