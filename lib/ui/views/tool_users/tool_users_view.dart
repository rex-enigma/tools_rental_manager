...
class ToolUsersView extends StackedView<ToolUsersViewModel> {
                        ...
                        return InkWell(
                          ...
                          child: Padding(
                            ...
                            child: CustomListTile(
                                  ...
                                  RichText(
                                    ...
                                    text: TextSpan(
                                      children: [
                                        ...
                                        TextSpan(
                                          text: toolUser.toolEntities?.length.toString() ?? '0',
                                          style: subtitleLastSubStringTextStyle(context),
                                        ),
                                      ],
                                    ),
                              ...
                              trailing: toolUser.toolEntities ==
  ...
  @override
  ToolUsersViewModel viewModelBuilder(BuildContext context) => locator<ToolUsersViewModel>();
