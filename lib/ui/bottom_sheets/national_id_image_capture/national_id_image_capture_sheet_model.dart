...
class NationalIdImageCaptureSheetModel extends BaseViewModel {
  final _navigationService = locator<NavigationService>();
  final _imagesRepoImp = locator<ImagesRepoImp>();

  // will hold an nationalIdImagePath if the previous View/BottomSheet that invoked it has one.
  // this nationalIdImagePath will be used when updating an image
  String? nationalIdImagePath;

  void fetchImageFromCamera() async {
    String? cameraImagePath = await _imagesRepoImp.fetchImagePath(
      source: ImageSource.camera,
      previousImagePath: nationalIdImagePath,
    );
