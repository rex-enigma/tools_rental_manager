...
class ToolArticleRepoImp implements ToolArticleRepo {
  ...
  ToolArticleImp({ToolArticlesRemoteDataSource? toolArticlesRemoteDataSource, ToolArticlesLocalDataSource? toolArticlesLocalDataSource}) {
    _toolArticlesRemoteDataSource = toolArticlesRemoteDataSource ?? locator.get<ToolArticlesRemoteWikipediaDataSource>();
    _toolArticlesLocalDataSource = toolArticlesLocalDataSource ?? locator.get<ToolArticleLocalSharedPreferencesDataSource>();
  }
